...
ua_infinix = 'Mozilla/5.0 (Linux; U; Android 8.0.0; en-us; Infinix X608 Build/OPR1.170623.032) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.109 Mobile Safari/537.36 PHX/10.0'
ua_crome = 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/110.0.5481.114 Mobile/15E148 Safari/604.1'
...
def banner():
    ...
    _logo_line_3_ = ('%s / _// / / __/ -_)   / /   ║  %sCoded By Bang Murdock XD  %s║'%(O,P,O))
